---
name: program-kursu
description: Generuje plik kurs/program.md — spersonalizowany program 14 modułów / 47 lekcji podstaw języka C# i platformy .NET, na podstawie wiedza/INDEX.md. Dostosowuje akcenty do celu ucznia (praca/narzędzia/hobby/szkoła) i deklarowanego tempa. Użyj raz, podczas onboardingu, po krótkim wywiadzie z uczniem.
---
...
**Zawsze** opieraj plan na pliku `wiedza/INDEX.md`. Nie wymyślaj modułów ani lekcji — tabele w INDEX.md to kanon: **14 modułów, 47 lekcji**.
...
2. **Skopiuj kanon** (14 modułów, 47 lekcji)
...
Personalizacja dotyczy **akcentów i projektu końcowego**, nie struktury. Wszystkie 47 lekcji zostaje w tej samej kolejności.
...
- Lekcja 1.2: Pierwszy program — `dotnet run`, `Console.WriteLine`
- Lekcja 1.3: Edytor, terminal, formatowanie kodu
...
[...kontynuuj wg INDEX.md, wszystkie 14 modułów, 47 lekcji...]
...
> „Czterdzieści siedem lekcji brzmi dużo, ale pierwsze siedem to podstawy, które przerobisz szybciej, niż myślisz. Prawdziwy próg jest w module 8 — tam zaczyna się to, co w C# jest naprawdę własne."
