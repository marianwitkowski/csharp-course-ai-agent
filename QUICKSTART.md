...
6. Wygeneruje **Twój** `kurs/program.md` (47 lekcji dopasowanych do celu)
...
Agent: [generuje program.md, student.json] Mam dla Ciebie 47 lekcji w 14 modułach,
       tempo ~3 lekcje/tydzień. Na końcu napiszesz własne narzędzie
       wiersza poleceń z testami.
       Zaczynamy od lekcji 1.1 — "Czym jest C# i .NET"?
...
- **[wiedza/INDEX.md](wiedza/INDEX.md)** — mapa 47 lekcji i lista tego, czego w kursie nie ma
