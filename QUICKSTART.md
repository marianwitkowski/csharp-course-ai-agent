...
Agent: [generuje program.md, student.json] Mam dla Ciebie 49 lekcji w 14 modułach,
...
- **[wiedza/INDEX.md](wiedza/INDEX.md)** — mapa 49 lekcji i lista tego, czego w kursie nie ma
