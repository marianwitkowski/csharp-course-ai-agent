...
6. Wygeneruje **Twój** `kurs/program.md` (50 lekcji dopasowanych do celu)
...
Agent: [generuje program.md, student.json] Mam dla Ciebie 50 lekcji w 14 modułach,
...
- **[wiedza/INDEX.md](wiedza/INDEX.md)** — mapa 50 lekcji i lista tego, czego w kursie nie ma
